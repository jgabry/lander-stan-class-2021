...
#### Materials and labor costs for maintaining the traps
...
forecast_plot <- ggplot(data = utility_df, aes(x = traps, y = utility)) +
...
forecast_plot
```
And we overlay the answer to the decision problem  show the maximum expected
utility and the corresponding number of traps to set.
